...
public class MyStringUtils {
    ...
    */
    ...
    public static boolean isNotEmpty(String str) {
        return !MyStringUtils.isEmpty(str);
    }
    ...
    public static String defaultIfBlank(String str, String defaultStr) {
        return MyStringUtils.isBlank(str) ? defaultStr : str;
    }
    ...
    public static String defaultIfEmpty(String str, String defaultStr) {
        return MyStringUtils.isEmpty(str) ? defaultStr : str;
    }
    ...
    public static boolean startsWithAny(String string, String[] searchStrings) {
        ...
        for (int i = 0; i < searchStrings.length; i++) {
            ...
            if (MyStringUtils.startsWith(string, searchString)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean endsWithAny(String string, String[] searchStrings) {
        ...
        for (int i = 0; i < searchStrings.length; i++) {
            String searchString = searchStrings[i];
            if (MyStringUtils.endsWith(string, searchString)) {
                return true;
            }
        }
        return false;
